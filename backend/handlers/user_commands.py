...
async def cmd_help(message: types.Message):
    ...
    await message.answer(
        ...
        "💡 **Важно:** Лента предназначена только для чтения. Чтобы прокомментировать пост или поставить реакцию, нажмите на кнопку 'Комментировать' — она откроет пост в самом Telegram.",
